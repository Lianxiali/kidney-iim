...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        // get_boundary_nodes(mesh, vein_node_coordinates, proximal_artery_node_coordinates, distal_artery_node_coordinates);
...
#pragma endregion
        ...
        std::unique_ptr<ExodusII_IO> exodus_io_thin(uses_exodus ? new ExodusII_IO(mesh) : NULL);
